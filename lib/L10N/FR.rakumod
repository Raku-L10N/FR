...
#- Generated on 2025-06-18T14:38:51+02:00 by ./update-localization
...
role L10N::FR {
    ...
    token enum-Broken { NonTenue}
    token enum-False { Faux}
    token enum-FileChanged { FileChanged}
    token enum-FileRenamed { FileRenamed}
    token enum-Kept { Tenue}
    token enum-Less { Moins}
    token enum-LittleEndian { LittleEndian}
    token enum-More { Plue}
    token enum-NativeEndian { NativeEndian}
    token enum-Planned { Promis}
    token enum-Same { Même}
